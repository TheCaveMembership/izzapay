...
# Local helpers you already have in your repo
...
# Session config (Pi Browser sandbox often blocks 3rd-party cookies; we also use URL tokens)
app.config.update(
...
def ensure_schema():
    with conn() as cx:
        # merchants: payout fields if missing
